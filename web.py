...
diabetes_model = pickle.load(open(r"G:\aicte internship microsoft\finalproject\Saved_models\diabetes_model.sav", "rb"))
Heart_model=pickle.load(open(r"G:\aicte internship microsoft\finalproject\Saved_models\Heart_model.sav","rb"))
pakinsons_model=pickle.load(open(r"G:\aicte internship microsoft\finalproject\Saved_models\pakinsons_model.sav","rb"))
